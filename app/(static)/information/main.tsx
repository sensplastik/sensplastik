...
export default function MainContent() {
  ...
  return (
    <>
      ...
      {/* Transparency & Accountability Content*/}
      <Wrapper id="transparency">
        {/* Content */}
        <Section>
      ...
      {/* Guiding Principles Content*/}
      <Wrapper id="guiding-principles">
        {/* Content */}
        <Section>
        ...
        <ContentTable
          ...
          items={[
            ...
            {
              title:
                'Act with conviction informed by deep research and analysis',
              content:
